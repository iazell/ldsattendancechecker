...
//                String easyPuzzle = intent1.getExtras().getString("epuzzle");
//
//                Log.e("respondents: " , easyPuzzle + "hello");
//                String[] result = easyPuzzle.split(",");
//
//                dataModels.add(new DataModel(result[0], result[1], result[2], result[0]));
